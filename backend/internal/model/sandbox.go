...
const (
	SandboxDriverKubernetes = "kubernetes"
...
type SandboxToolMount struct {
	...
	Ref       string `json:"ref,omitempty"`  // existing PVC/ConfigMap/Secret name or logical ref
	MountPath string `json:"mountPath"`
	Mode      string `json:"mode,omitempty"` // ro / rw
}

// SandboxNetworkPolicy controls pod egress. Kubernetes NetworkPolicy support
// depends on the CNI implementation, so this is a declarative desired policy;
// operators should verify enforcement in their cluster.
